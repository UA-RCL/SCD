...
module TrueDualPortRAM_ASyncReads
#(
...
//    parameter filename = "";
    (* ram_style = "register" *)reg [wordWidth-1:0] myMemory [2**addrSize-1:0];
...
//        end
    ...
    assign dataOut1 = myMemory[addr1];
    assign dataOut2 = myMemory[addr2];
